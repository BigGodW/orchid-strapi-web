...
export interface ApiOrchidCategoryOrchidCategory
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::orchid-category.orchid-category'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    orchids: Schema.Attribute.Relation<'oneToMany', 'api::orchid.orchid'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOrchidTypeOrchidType extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    orchids: Schema.Attribute.Relation<'manyToMany', 'api::orchid.orchid'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOrchidOrchid extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    breeder: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u4E2D\u56FD\u5170\u82B1\u535A\u89C8\u56ED'>;
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    orchid_category: Schema.Attribute.Relation<
      'manyToOne',
      'api::orchid-category.orchid-category'
    >;
    orchid_types: Schema.Attribute.Relation<
      'manyToMany',
      'api::orchid-type.orchid-type'
    >;
    origin: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::orchid-type.orchid-type': ApiOrchidTypeOrchidType;
      'api::orchid.orchid': ApiOrchidOrchid;
